...
export const footerLinkSections: FooterLinkSection[] = [
  {
    ...
    links: [
      ...
      { label: "Crociere Fluviali", href: "/crociere-fluviali" },
      { label: "I Nostri Tour", href: "/tour" },
  ...
  },
  {
    title: "Info Utili",
    links: [
      { label: "Come Prenotare", href: "/come-prenotare" },
      { label: "Assicurazioni Viaggio", href: "/assicurazioni" },
      { label: "Documenti di Viaggio", href: "/documenti" },
      { label: "FAQ", href: "/faq" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Trova Agenzia", href: "/trova-agenzia" },
      { label: "Materiale Marketing", href: "/materiale-marketing" },
