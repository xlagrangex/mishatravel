                      ...
                      >
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-3 mt-1.5 text-sm text-gray-600">
                            <span className="flex items-center gap-1"><MapPin className="size-3.5" />{dep.destination}</span>
                            <span className="flex items-center gap-1"><Clock className="size-3.5" />{dep.duration}</span>
