  ...
  return (
    <>
      <PageHero
        ...
        subtitle="La pagina che cerchi non è disponibile"
        breadcrumbs={[{ label: '404', href: '#' }]}
      />
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="-mt-10 space-y-3 sm:-mt-14">
            <h2 className="font-[family-name:var(--font-poppins)] text-2xl font-bold text-[#1B2D4F] sm:text-3xl">
