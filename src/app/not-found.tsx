    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-50 border-b bg-white">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-[#1B2D4F] sm:flex">
            <Link href="/tours" className="transition-colors hover:text-[#C41E2F]">Tour</Link>
            <Link href="/crociere" className="transition-colors hover:text-[#C41E2F]">Crociere</Link>
            <Link href="/destinazioni" className="transition-colors hover:text-[#C41E2F]">Destinazioni</Link>
            <Link href="/contatti" className="transition-colors hover:text-[#C41E2F]">Contatti</Link>
          </nav>
        </div>
      </header>

      {/* Main content */}
      <main className="flex flex-1 flex-col items-center justify-center bg-gradient-to-b from-white to-gray-50/80 px-4 py-16 text-center">
        {/* Animated 404 number */}
